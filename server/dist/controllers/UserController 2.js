...
class UserController {
    ...
    createUser(email, password, firstName, lastName, isActive, profilePicUrl) {
        return __awaiter(this, void 0, void 0, function* () {
            const newUser = new User_1.User({
                firstName,
                lastName,
                email,
                password: utils_1.Utils.encryptPassword(password),
                profilePicUrl,
                isActive
            });
            return newUser.save();
    ...
    updateUser(userId, email, firstName, lastName, isActive) {
        return __awaiter(this, void 0, void 0, function* () {
            const user = yield User_1.User.find({ where: { userId: userId } });
            if (user) {
    ...
    deleteUser(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            const user = yield User_1.User.find({ where: { userId } });
            if (user) {
                yield user.destroy();
                return user;
            }
